...
?>
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="../images/Feria/banner/1.jpg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="../images/Feria/banner/2.jpg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="../images/Feria/banner/3.jpg" class="d-block w-100" alt="...">
        </div>
    </div>
